...
export const typesConsultation = [
  {
    ...
    price: "50,000",
    details: [
      { id: 1, name: "On site Consultation" },
      { id: 2, name: "Secure end-end data Encryption" },
      { id: 2, name: "Experts in a wide range of specializations" },
      { id: 2, name: "One-on-one with a certified doctor" },
      { id: 2, name: "Recommended treatment plans" },
    ],
  },
  {
    id: 1,
    ...
    price: "10,000",
    details: [
      { id: 1, name: "Convenient & hassle free" },
      { id: 2, name: "Secure end-end data Encryption" },
      { id: 2, name: "Experts in a wide range of specializations" },
      { id: 2, name: "One-on-one with a certified doctor" },
      { id: 2, name: "Recommended treatment plans" },
