...
const VaccineDetails = () => {
  ...
  return (
    <>
      <div className="my-10 md:mt-30 grid grid-cols-1 md:grid-cols-2 max-w-7xl p-6 mx-auto">
        <div>
        ...
        <div className="flex items-start flex-col gap-3">
          ...
          <div className="flex flex-col items-start gap-2">
            ...
            <a
              ...
              className="group text-green-500 hover:text-white hover:bg-green-500 rounded-full p-2 transition duration-200 text-xl flex gap-1 items-center"
            >
              <FaWhatsapp />
